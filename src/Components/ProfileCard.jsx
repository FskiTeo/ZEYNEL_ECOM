        ...
        <Card className="w-2/3 md:w-1/2 lg:w-1/3 bg-white rounded-lg border border-gray-200 shadow-md">
            <CardContent className="border-t border-gray-200">
                <div className="flex items-center space-x-4 p-5">
                    <Avatar src={props.userData.avatar} alt={props.userData.name + " Picture"} className="aspect-square" />
                    <div>
                        <h2 className="text-2xl font-bold">{props.userData.name}</h2>
                        <p className="text-gray-600">{props.userData.role}</p>
                    </div>
                </div>
                <div className="flex flex-col p-5 space-y-3">
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <div className="text-sm text-gray-500" id="role">
                            {props.userData.role}
                        </div>
                    </div>
                    <div className="flex flex-col space-y-1">
